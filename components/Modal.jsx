...
function Modal({setModal}) {
  return (
    ...
    <div className="absolute top-16 bg-white hidden sm:block shadow-sm shadow-gray-300    h-[65vh] w-[85vw]  left-24 right-24   rounded-md p-6 overflow-auto modalArea">
