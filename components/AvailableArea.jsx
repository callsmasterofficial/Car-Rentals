    ...
    <div className="Available-image AvailableArea-image-mobile opacity-90 mt-8	relative  ">
      <div className="mt-20px w-[90%] mx-auto lg:w-[80%] p-4 mb-2">
        ...
        {/* <div className="text-center mt-6 ">
          ...
          <botton className="text-white p-2 w-[40%] bg-black rounded text-center">
            Download on the
          </botton>
        </div> */}

        <div className="flex appBtn justify-center	sm:mt-6 Availaible-mobile-buttons ">
          <button className="bg-black text-white inline-flex py-1 px-2 sm:py-3 sm:px-5 rounded-lg items-center focus:outline-none ">
            <svg
            ...
            >
              <path
                d="M99.617 8.057a50.191 50.191 0 00-38.815-6.713l230.932 230.933 74.846-74.846L99.617 8.057zM32.139 20.116c-6.441 8.563-10.148 19.077-10.148 30.199v411.358c0 11.123 3.708 21.636 10.148 30.199l235.877-235.877L32.139 20.116zM464.261
        212.087l-67.266-37.637-81.544 81.544 81.548 81.548 67.273-37.64c16.117-9.03 25.738-25.442 25.738-43.908s-9.621-34.877-25.749-43.907zM291.733 279.711L60.815 510.629c3.786.891 7.639 1.371 11.492 1.371a50.275 50.275 0 0027.31-8.07l266.965-149.372-74.849-74.847z "
              ></path>
            </svg>
          ...
          <button className="bg-black text-white inline-flex py-1 px-2 sm:py-3 sm:px-5  rounded-lg items-center ml-2 focus:outline-none Availaible-mobile-button2 ">
            ...
            >
              <path
                d="M40.74 112.12c-25.79 44.74-9.4 112.65 19.12 153.82C74.09 286.52 88.5 305 108.24 305c.37 0 .74 0 1.13-.02 9.27-.37 15.97-3.23 22.45-5.99 7.27-3.1 14.8-6.3 26.6-6.3 11.22 0 18.39 3.1 25.31 6.1 6.83 2.95 13.87 6 24.26
        ...
        0-25.56 4.93-35.61 8.9-6.94 2.73-12.93 5.09-17.06 5.09-4.64 0-10.67-2.4-17.65-5.16-9.33-3.7-19.9-7.9-31.1-7.9l-.79.01c-26.03.38-50.62 15.27-64.18 38.86z "
              ></path>
